...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/lloricode/php-timezone.svg?style=flat-square)](https://packagist.org/packages/lloricode/php-timezone)
[![Tests](https://img.shields.io/github/actions/workflow/status/lloricode/php-timezone/tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/lloricode/php-timezone/actions/workflows/tests.yml)
[![Total Downloads](https://img.shields.io/packagist/dt/lloricode/php-timezone.svg?style=flat-square)](https://packagist.org/packages/lloricode/php-timezone)
[![codecov](https://codecov.io/gh/lloricode/php-timezone/branch/main/graph/badge.svg?token=S1INCAHVSV)](https://app.codecov.io/gh/lloricode/php-timezone/tree/main)
...
$timezones = Lloricode\Timezone\Timezone::generateList();
...
[
    ...
    "America/Ciudad_Juarez" => "(UTC-07:00) America/Ciudad_Juarez",
